...
Module Module_draw5
    Public Sub Createdqdxf5(ByVal strfilename As String, ByVal dt As DataTable， ByVal datatable_B As DataTable， ByVal datatable_T As DataTable)
  ...
  New Vector2(x_next, dy1_next)
            ...
            Call DrawElevations(doc, x, dy1, dy1)
            'Call DrawElevations(doc, (x + x_next) * 0.5, （dy2 + dy2_next） * 0.5, dy2)
            Call DrawElevations(doc, (x + x_next) * 0.5, dy2, dy2)
