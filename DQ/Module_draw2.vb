...
Module Module_draw2
    ...
    Public Sub Createdqdxf2(ByVal strfilename As String)
        ''台阶水平开挖，每段一个台阶
        ...
        For i = 0 To dtTemplate.Rows.Count - 2
            ...
            Dim dy1_next As Double = dtTemplate.Rows(i)("dy1")
            Dim dy1_temp As Double = Math.Min(dy1, dy1_next)

            '以下绘制剖分线
            Dim vertexes_1 As New List(Of Vector2) From {
    New Vector2(x, dy2),
    New Vector2(x, dy1_temp)
     }

            Dim vertexes_2 As New List(Of Vector2) From {
    New Vector2(x_next, dy2_next),
    New Vector2(x_next, dy1_temp)
     }
